...
CREATE TABLE `food` (
  ...
  `food_protein` int(5) NOT NULL COMMENT '餐點蛋白質',
  `food_fat` int(5) NOT NULL COMMENT '餐點脂肪',
  `food_carbs` int(5) NOT NULL COMMENT '餐點碳水化合物',
...
--
ALTER TABLE `food`
  MODIFY `food_id` int(6) NOT NULL AUTO_INCREMENT COMMENT '餐點編號', AUTO_INCREMENT=7;
COMMIT;
