...
<body>
    ...
    $sql_query = "SELECT `food_id`, `food_image`, `food_name`, `food_detail`, `food_price`, `food_protein`, `food_fat`, `food_carbs`, `food_calorie` FROM `food` WHERE `store_id`='" . $row_Recstore["id"] . "'";
